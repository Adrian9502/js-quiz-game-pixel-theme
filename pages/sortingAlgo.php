...
<head>
  ...
  <title>Sorting Algorithm - Quiz</title>
...
<body>
  <sidebar class="sidebar">
    ...
    <div class="sidebar-content">
      <h2 class="sidebar-title">SORTING ALGORITHM</h2>
      ...
      <div class="sidebar-content-exercises exercises-container" data-category="Bubble Sort">
        <div class="menu-title bubble">Bubble Sort</div>
        <!-- menu item -->
      ...
      <div class="sidebar-content-exercises exercises-container" data-category="Merge Sort">
        <div class="menu-title merge">Merge Sort</div>
        <!-- menu item -->
        <div class="exercises-wrapper">
          <div class="exercises" data-index="0">Exercise 1</div>
          <div class="exercises" data-index="1">Exercise 2</div>
      ...
      <div class="sidebar-content-exercises exercises-container" data-category="Selection Sort">
        <div class="menu-title selection">Selection Sort</div>
        <!-- menu item -->
        <div class="exercises-wrapper">
          <div class="exercises" data-index="0">Exercise 1</div>
          <div class="exercises" data-index="1">Exercise 2</div>
      ...
      <div class="sidebar-content-exercises exercises-container" data-category="Insertion Sort">
        <div class="menu-title insertion">Insertion Sort</div>
        <!-- menu item -->
        <div class="exercises-wrapper">
          <div class="exercises" data-index="0">Exercise 1</div>
          <div class="exercises" data-index="1">Exercise 2</div>
  ...
  <main class="main-content">
    ...
    <div class="exercise">
      ...
      <div class="submit-answer">
        <button class="ex-area-btn primary submit-answer-button">
          Submit Answer &gt;
        </button>
      </div>
    </div>
